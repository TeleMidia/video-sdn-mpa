...
class ProjectController(app_manager.RyuApp):
    ...
    def get_paths(self, src, dst):
        '''
        Encontrando todos os caminhos da origem ao destino usando DFS
    ...
    def get_link_cost(self, s1, s2):
        '''
        Encontrando o custo do link entre dois switches
    ...
    def get_path_cost(self, path):
        '''
        Encontrando o custo do caminho
        Get the path cost
        '''
        cost = 0
    ...
    def get_optimal_paths(self, src, dst):
        '''
        Encontrando os melhores caminhos, a quantidade depende de MAX_PATHS
    ...
    def generate_openflow_gid(self):
        '''
        Retorna um ID de grupo aleatorio do OpenFlow, pq?
    ...
    def install_paths(self, src, first_port, dst, last_port, ip_src, ip_dst):
        '''
        Instalacao dos caminhos
        '''
        computation_start = time.time()
        #seleciona os melhores caminhos
        ...
        for node in switches_in_paths:
            ...
            actions = []
            i = 0
            #Aparentemente associa a porta de saida com a porta de entrada do proximo switch e o peso de cada porta de saida.
